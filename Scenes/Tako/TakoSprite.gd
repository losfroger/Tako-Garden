...
const SPRITES = {
	"tako": preload("res://Assets/Art/Tako/TakoSpritesheet.png"),
	"ika": preload("res://Assets/Art/Tako/IkaSpritesheet.png"),
	"gold_tako": preload("res://Assets/Art/Tako/GoldTakoSpritesheet.png"),
}
